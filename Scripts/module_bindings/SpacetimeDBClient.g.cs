...
namespace SpacetimeDB.Types
{
    ...
    public sealed partial class RemoteTables : RemoteTablesBase
    {
        public RemoteTables(DbConnection conn)
        {
            ...
            AddTable(NearbyRemotePlayerRotations = new(conn));
            ...
            AddTable(PlayerRotation = new(conn));
    ...
    public sealed class QueryBuilder
    {
        ...
        internal static string[] AllTablesSqlQueries() => new string[]
        {
            ...
            new QueryBuilder().From.NearbyRemotePlayerRotations().ToSql(),
            ...
            new QueryBuilder().From.PlayerRotation().ToSql(),
    ...
    public sealed class From
    {
        ...
        public global::SpacetimeDB.Table<PlayerRotation, NearbyRemotePlayerRotationsCols, NearbyRemotePlayerRotationsIxCols> NearbyRemotePlayerRotations() => new("nearby_remote_player_rotations", new NearbyRemotePlayerRotationsCols("nearby_remote_player_rotations"), new NearbyRemotePlayerRotationsIxCols("nearby_remote_player_rotations"));
        ...
        public global::SpacetimeDB.Table<PlayerRotation, PlayerRotationCols, PlayerRotationIxCols> PlayerRotation() => new("player_rotation", new PlayerRotationCols("player_rotation"), new PlayerRotationIxCols("player_rotation"));
    ...
    public sealed class DbConnection : DbConnectionBase<DbConnection, RemoteTables, Reducer>
    {
        ...
        protected override bool Dispatch(IReducerEventContext context, Reducer reducer)
        {
            ...
            return reducer switch
            {
                ...
                Reducer.ReportScreenRotation args => Reducers.InvokeReportScreenRotation(eventContext, args),
                ...
                Reducer.UpsertMovementDef args => Reducers.InvokeUpsertMovementDef(eventContext, args),
                Reducer.UpsertMultiStepDef args => Reducers.InvokeUpsertMultiStepDef(eventContext, args),
                Reducer.UpsertRepeatStepDef args => Reducers.InvokeUpsertRepeatStepDef(eventContext, args),
                Reducer.UpsertSingleStepDef args => Reducers.InvokeUpsertSingleStepDef(eventContext, args),
