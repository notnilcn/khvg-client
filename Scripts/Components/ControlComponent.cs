...
/// <summary>
/// Component base for components whose scene root is a Control (UI components) — the
/// comedot rule that a component scene's root is the closest matching builtin type.
/// Registration behavior mirrors Component; the bases share ComponentRegistration because
/// C# allows only one base class.
/// </summary>
public abstract partial class ControlComponent : Control, IComponent
{
