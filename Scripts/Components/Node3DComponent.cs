...
/// <summary>
/// Component base for components whose scene root is a Node3D — the comedot rule that a
/// component scene's root is the closest matching builtin type. Registration behavior
/// mirrors Component; the bases share ComponentRegistration because C# allows only one
/// base class. Used by the components inside world_3d.tscn, which register with the
/// GameManager entity through the SubViewport ancestor walk.
/// </summary>
public abstract partial class Node3DComponent : Node3D, IComponent
{
