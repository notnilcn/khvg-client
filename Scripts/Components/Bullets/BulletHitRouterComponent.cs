...
/// <summary>
/// Routes BlastBullets2D enemy-bullet overlaps to the server: the player's hurtbox
/// (DamageReceivingComponent) forwards the hit to the ReportHit reducer; the fallback
/// covers bullets hitting anything else on the player collision layer (logic moved out
/// of BulletManager.cs).
/// </summary>
